 ...
 * @author oscar
 */
public class ReporteErroresGraphik {
    ...
    public void crearHtml(int numero) throws IOException {
        ...
        try {
            filewriter = new FileWriter("C:\\Users\\oscar\\Desktop\\Disk\\USAC\\2017\\Primer Semestre\\Compi 2\\Proyecto1\\Reporte de error GRAPHIK .html");//declarar el archivo
            ...
            printw.println("<h3><p> Lenguaje GRAPHIK - Reporte Errores</p></h3>");

            //podemos añadir imagenes con codigo html
            printw.println("<hr style=\"color:white;\">");
            int contador = 0;
            for (Errores error : ManejadorErrores.getInstancia().getListaErroresGraphik()) {
                String descripcion = "";
